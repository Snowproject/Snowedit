                        ...
                        <div class="content">
                            <div class="habblet-container" style="float:left; width:210px;">
                                ...
                                <div class="cbb habboclub-tryout">
                                    <h2 class="title">Purchase VIP</h2>
                                    <div class="box-content">
                                        <div class="habboclub-banner-container habboclub-clothes-banner"></div>
                                        <p class="habboclub-header">{hotelName} VIP is exclusive: absolutely no riff-raff admitted! Members enjoy a wide range of benefits, including exclusive clothes, free gifts and an extended Friend List.</p>
                                        <p class="habboclub-link"><a href="{url}/shop">Check out {hotelName} VIP &gt;&gt;</a></p>
                                    </div>
                                </div>
                            </div>
