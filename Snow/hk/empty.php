 ...
 <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <form action="empty2" method=POST>
Table<br /><input type=text name=table><br /><br />
<input type=submit value="Empty table">
</form>
<h1><strong>NOTE: There is no going back, this will permenatly delete all records in that table!!!</strong></h1>
