...
$Badge_id = mysql_real_escape_string($_POST['badge_id']);
$Slot_id = mysql_real_escape_string($_POST['badge_slot']);

mysql_query("DELETE FROM user_badges WHERE user_id='$User_id' AND badge_id='$Badge_id'") or die(mysql_error());
echo ("Badge has been deleted!"); 
}
...
<html>
<body>
<h1>Okay. If you see 'Badge has been deleted!' at the top, then it has completed successfully.</h1>
