 ...
 <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <form action="delbadge2" method=POST>
User ID<br /><input type=text name=user_id><br /><br />
Badge ID<br /><input type=text name=badge_id><br /><br />
Badge slot<br /><input type=text name=badge_slot><br /><br />
<input type=submit value="Delete User Badge">
</form>
