    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <div id="content">
          ...
          <br />          
<form method="post" action="addbadge2">
	User ID<br />
	<input type="text" name="user_id"/> <br /> <br />
	Badge ID <br />
	<input type="text" name="badge_id"/> <br /> <br />
	Badge Slot (0 or 1)<br />
	<input type="text" name="badge_slot"/> <br /> <br />
	<input type="submit" value="Add badge" name="badge1" />
	</form>
	<?php
