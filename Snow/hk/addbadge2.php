...
mysql_query("INSERT INTO user_badges (user_id,badge_id,badge_slot) VALUES ('$User_id','$Badge_id','$Slot_id')");
echo ("Badge has been added!"); 
}
...
<html>
<body>
<h1>Okay. If you see 'Badge has been added!' at the top, then it has completed successfully.</h1>
