...
{
$message = mysql_real_escape_string($_POST['motd']);

mysql_query("UPDATE server_settings SET motd = '$message'");
echo ("Welcome message updated successfully.");
}
		  ?>
		  
		  
		  <h1>If you see "Welcome message updated successfully." at the top, then it has all gone great! Remember to do :update_settings on the client to make it live!</h1>
