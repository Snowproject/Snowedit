...
$query = mysql_query("UPDATE server_settings SET timer = '$timer', pixels = '$pixels', credits = '$credits'");
echo ("Timer has updated successfully");
}
...
<html>
<body>
<h1>Okay. If you see "Timer has updated successfully" at the top, then it has completed successfully.</h1>
